				...
				<form className="space-y-5">
					...
					<div className="flex justify-center">
						<button
							...
							className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
						>
							Create
						</button>
					</div>
