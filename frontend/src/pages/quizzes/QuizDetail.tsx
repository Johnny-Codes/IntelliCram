...
const QuizDetail = () => {
  ...
  return (
    <form className="flex items-center justify-center" onSubmit={handleSubmit}>
      <div className="mx-auto p-4 bg-blue-100 rounded-md shadow-md min-w-full">
        <h1 className="text-3xl font-bold mb-4 text-center">Quiz</h1><hr className="border border-b-2 border-white"></hr>
        {quiz.map((question) => (
              ...
              {question.answers.map((answer) => (
                <div key={answer.id} className="mb-2">
                  ...
                  <label
                    ...
                    className={`text-base ${showCorrectAnswers
